...
//void submodularGreedyMatching(LightGraph &, NODE_T [], float,  WeightEdgeList &, SUM_T &, NODE_T &);

void submodularGreedybMatching(LightGraph &, NODE_T [], NODE_T [], float, std::vector<VAL_T> &, WeightEdgeList &, SUM_T &, NODE_T &);

void localLazyGreedy(LightGraph &, NODE_T [], NODE_T [], float,  std::vector<VAL_T> &, WeightEdgeList &, SUM_T &, NODE_T &);

void localLazyGreedy(LightGraph &, NODE_T [], NODE_T [], float, std::vector<VAL_T> &, WeightEdgeList &, SUM_T &, NODE_T &, double epsilon = 1.0 );

void shmLocalLazyGreedy(LightGraph &, NODE_T [], int, float,  WeightEdgeList &, SUM_T &, SUM_T &, NODE_T &,double &, int = 1);
