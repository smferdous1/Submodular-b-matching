...
void submodularGreedybMatching(LightGraph &, NODE_T [], NODE_T [], float, int, WeightEdgeList &, SUM_T &, NODE_T &,int = 1);
void localLazyGreedy(LightGraph &, NODE_T [], NODE_T [], float, int, WeightEdgeList &, SUM_T &, NODE_T &,int = 1);
